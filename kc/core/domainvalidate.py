"""KeepCloud domain validation module."""
import os


class KCDomain:
    """KeepCloud domain validation utilities"""
    ...
    def getlevel(self, domain):
        ...
        domain_type = ''
        if os.path.isfile("/var/lib/kc/public_suffix_list.dat"):
            # Read mode opens a file for reading only.
            suffix_file = open(
                "/var/lib/kc/public_suffix_list.dat", encoding='utf-8')
